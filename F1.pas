...
implementation
	...
	begin
		...
		begin
			...
			val(copy(data,1,pos('/',data)-1), v2, e);
			inventoriMentah.TanggalBeli.hari := v2;
			delete(data,1,pos('/',data));
			
			val(copy(data,1,pos('/',data)-1), v2, e);
			inventoriMentah.TanggalBeli.bulan := v2;
			delete(data,1,pos('/',data));
			
			val(copy(data,1,pos('|',data)-2), v2, e);
			inventoriMentah.TanggalBeli.tahun := v2;
			delete(data,1,pos('|',data)+1);
		...
		begin
			...
			val(copy(data,1,pos('/',data)-1), v2, e);
			inventoriOlahan.TanggalBuat.hari := v2;
			delete(data,1,pos('/',data));
			
			val(copy(data,1,pos('/',data)-1), v2, e);
			inventoriOlahan.TanggalBuat.bulan := v2;
			delete(data,1,pos('/',data));
			
			val(copy(data,1,pos('|',data)-2), v2, e);
			inventoriOlahan.TanggalBuat.tahun := v2;
			delete(data,1,pos('|',data)+1);
		...
		begin
			...
			//Membaca tanggal
			val(copy(data,1,pos('/',data)-1), v2, e);
			vsimulasi.Tanggal.hari := v2;
			delete(data,1,pos('/',data));
			
			val(copy(data,1,pos('/',data)-1), v2, e);
			vsimulasi.Tanggal.bulan := v2;
			delete(data,1,pos('/',data));
			
			val(copy(data,1,pos('|',data)-2), v2, e);
			vsimulasi.Tanggal.tahun := v2;
			delete(data,1,pos('|',data)+1);
